...
begin
  ...
  begin
    ...
    RegisterMethod
      ('Function RunCommand( const aFilename : String; const aDirectory : string; const aParameters : String) : Integer');
  end;
end;
...
(* ---------------------------------------------------------------------------- *)
procedure TPSImport_API_Shell.ExecImport1(CompExec: TPSScript;
