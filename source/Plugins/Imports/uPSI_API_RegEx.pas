...
begin
  ...
  begin
    RegisterMethod('Function Match( aRegEx : String; aText : String; var aMatching : String) : boolean');
  end;
end;
...
(*----------------------------------------------------------------------------*)
procedure TPSImport_API_RegEx.ExecImport1(CompExec: TPSScript; const ri: TPSRuntimeClassImporter);
begin
