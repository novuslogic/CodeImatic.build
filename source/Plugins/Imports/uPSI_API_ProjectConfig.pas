...
(* === run-time registration functions === *)
(*----------------------------------------------------------------------------*)
procedure TAPI_ProjectConfigWorkingdirectory_R(Self: TAPI_ProjectConfig; var T: string);
begin T := Self.Workingdirectory; end;

(*----------------------------------------------------------------------------*)
procedure TAPI_ProjectConfigSearchPath_R(Self: TAPI_ProjectConfig; var T: String);
begin T := Self.SearchPath; end;

(*----------------------------------------------------------------------------*)
procedure TAPI_ProjectConfigProjectConfigFileName_R(Self: TAPI_ProjectConfig; var T: String);
begin T := Self.ProjectConfigFileName; end;
...
(*----------------------------------------------------------------------------*)
procedure TPSImport_API_ProjectConfig.ExecImport1(CompExec: TPSScript; const ri: TPSRuntimeClassImporter);
begin
