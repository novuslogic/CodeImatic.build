...
begin
  ...
  begin
    ...
    RegisterProperty('ProjectItem', 'TProjectItem', iptrw);
...
(*----------------------------------------------------------------------------*)
procedure TMessagesLogProjectItem_W(Self: TMessagesLog; const T: TProjectItem);
begin Self.ProjectItem := T; end;

(*----------------------------------------------------------------------------*)
procedure TMessagesLogProjectItem_R(Self: TMessagesLog; var T: TProjectItem);
begin T := Self.ProjectItem; end;
...
begin
  ...
  begin
    ...
    RegisterPropertyHelper(@TMessagesLogProjectItem_R,@TMessagesLogProjectItem_W,'ProjectItem');
