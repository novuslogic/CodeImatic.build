...
begin
  ...
  begin
    RegisterMethod('Function KeyExists( const aHKEY : Int64; const aKey : String) : boolean');
    RegisterMethod('Function ReadString( const aHKEY : Int64; const aKey : String; const aName : string) : String');
  end;
end;
...
begin
 ...
 CL.AddConstantN('HKEY_PERFORMANCE_DATA','LongWord').SetUInt( Int64 ( $80000004 ));
 ...
 CL.AddConstantN('API_Registry_MissingRegKey','String').SetString( 'Missing Registery Key [%s]');
...
(*----------------------------------------------------------------------------*)
procedure TPSImport_API_Registry.ExecImport1(CompExec: TPSScript; const ri: TPSRuntimeClassImporter);
begin
