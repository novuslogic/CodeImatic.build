...
uses
  APIBase, API_Output, NovusFileUtils, API_File;
...
begin
  ...
  begin
    ...
    RegisterMethod(@TAPI_File.IncludeTrailingPathDelimiter,
    ...
    RegisterMethod(@TAPI_File.MakeTmpFileName, 'MakeTmpFileName');
  end;
end;
...
(* ---------------------------------------------------------------------------- *)
procedure TPSImport_API_File.ExecImport1(CompExec: TPSScript;
