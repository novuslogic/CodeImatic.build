...
type
  ...
  public
    ...
    function ReadString(const aHKEY: Int64; const aKey: String;
...
function TAPI_Registry.ReadString(const aHKEY: Int64; const aKey: String;
  const aName: string): String;
var
...
function TAPI_Registry.KeyExists(const aHKEY: Int64;
