...
uses Classes, Plugin, NovusPlugin, Project,
  SysUtils, System.Generics.Defaults, runtime, Config,
  APIBase, uPSRuntime, uPSCompiler, API_Output, variants,
  uPSC_classes, uPSC_std, uPSR_std, uPSR_classes, uPSR_ExtraClasses,
  uPSC_dateutils, uPSC_comobj, uPSR_comobj, uPSC_dll,
  uPSR_dll,  uPSR_dateutils, uPSI_ExtraClasses, ExtraClasses;
...
constructor tPlugin_SystemExtBase.Create(aAPI_Output: tAPI_Output; var aImp: TPSRuntimeClassImporter; aPluginName: String);
begin
  Inherited;
end;
...
function TPlugin_SystemExt.CreatePlugin(aAPI_Output: tAPI_Output; aImp: TPSRuntimeClassImporter): TPlugin;
begin
  FPlugin_SystemExt := tPlugin_SystemExtBase.Create(aAPI_Output,aImp,PluginName);
