...
type
  tPlugin_File = class(TPascalScriptInternalPlugin)
  private
  protected
...
constructor tPlugin_File.Create(aAPI_Output: tAPI_Output;
...
begin
  ...
  uPSRuntime.SetVariantToClass(aExec.GetVarNo(aExec.GetVar('File')),
    foAPI_File);
end;
